                ...
                _vm.showCancelButton
                  ? _c(
                      "el-button",
                      {
                        ...
                        nativeOn: {
                          click: function($event) {
                            _vm.handleAction("cancel", "btnEvent")
                          }
                        }
                      },
                      [
...
/* harmony default export */ var mainvue_type_script_lang_js_ = ({
  ...
  methods: {
    ...
    doClose: function doClose() {
      ...
      this.doAfterClose();
      setTimeout(function () {
        if (_this2.action) _this2.callback(_this2.action, _this2, _this2.cancelEventType);
      });
    },
    ...
    handleAction: function handleAction(action, eventType) {
...
var defaultCallback = function defaultCallback(action, message, cancelEventType) {
  if (currentMsg) {
    ...
    if (currentMsg.resolve) {
      if (action === 'confirm') {
        ...
        currentMsg.reject({ type: action, cancelEventType: cancelEventType });
      }
    }
  }
};
...
var main_showNextMsg = function showNextMsg() {
  ...
  if (!instance.visible || instance.closeTimer) {
    if (msgQueue.length > 0) {
      ...
      instance.callback = function (action, instance, cancelEventType) {
